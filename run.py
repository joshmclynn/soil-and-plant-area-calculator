...
def plantcalc():
    ...
    of the area they wish to plant the function then calculates the area in m^2
    ...
    while True:
        print(break_line)
        print("Please input the length of the area(M/CM)and press enter")
    ...
    while True:
        print(break_line)
        print("Please enter the width of the area(M/CM) and press enter")
...
def calc_plant(total_area, pot_choice):
    """
    This function calculates the total plants needed for the user to fill their
    area, by dividing the total area by the  users selected pot size,
    ...
    print(break_line)
    print("To fill the area with", pot_type, "pots, you would need")
    print(amount_needed_round, "pots")
    print("If you would like to know the average cost for")
    print(amount_needed_round, "pots")
...
def plant_price(pot_type, amount_needed_round):
    ...
    Using a for loop to create tuples within a list grouping the plant to the
    correct pricing.
    """
    print(break_line)
    print("Here are examples of total prices for the amount of plants that")
    print("you would need for the pot size you want")
    print(" Formatted = Plant-Name / total price in pounds")
    ...
    display_list = []
    full_price = [(int(float(price_list[i])) * amount_needed_round)
...
def calcarea():
    ...
    prompting them to re-enter if otherwise, it then calculates the volume of
    the area, then converts this number into litres then returning this
    ...
    while True:
        print(break_line)
        print("Please enter the depth of the area(M/CM) and press enter")
...
def hundredbag(volume):
    ...
    print("If you would like to order a smaller bag enter 1")
    print("or 2 to continue with your order")
...
def validate_card():
    """
    This function prompts the user to enter a 12 digit card number,
    if the user enters anything aside from
    numbers and if it is more or less that 12 the input is invalid
    and the user is prompted to enter again
    """
    print(break_line)
...
def addtoorders(cardno, pricedue):
    ...
    1000 for the users order number.
    this function also returns the users order number allowing them to
    cancel that order in the future using other
    ...
    print(break_line)
    print("Your order num is", orderno, "you can use it to cancel your order")
...
def cancelorder():
    ...
    allows the user to enter there order number and if this number corresponds
    to a number within the spreadsheet held on google sheets the user is
    returned the option to cancel there order, it then communicates with
    google sheets and deletes the row from the spreadsheet
    If the order number doesnt exist the user is returned a message
    that the order number is incorrect
    """
    print(break_line)
...
def main():
    """
    This is the main function with the options allowing the user to navigate
    through the application, It has 3 options to choose from which will send
    the user to the chosen part. The user will also be returned here after
    using each one of the different options
    """
    print("""
            --------------PLANT AND SOIL CALCULATOR---------------------------
                                                                        """)
    print("""
